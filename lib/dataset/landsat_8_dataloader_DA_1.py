...
from lib.dataset.ladsat_8_dataset_DA_1 import Landsat,Landsat_multi_scale,Landsat_RGB,Landsat_multi_2_scale
...
# print(random.choice(operate_set))
# print(operate_set)
...
def Get_dataloader_enhance(args):
    ...
    if args.kind == 'single':
        train = Landsat(args.trainset, transform_train)
        test = Landsat(args.testset, None)
    ...
    if args.kind == 'multi_2':
        train = Landsat_multi_2_scale(args.trainset)
        test = Landsat_multi_2_scale(args.testset)
