...
class SPNet(nn.Module):
    ...
    def forward(self, x):
        ...
        out = F.relu(self.res_block11(out) + out)
        out = F.relu(self.res_block12(out) + out)

        out = F.relu(self.res_block13(out) + out)
        out = F.relu(self.res_block14(out) + out)
        out = F.relu(self.res_block15(out) + out)
...
class NoRNet(nn.Module):
    ...
    def forward(self, x):
        ...
        out = F.relu(self.res_block16(out) )
        out = F.relu(self.res_block17(out) )
